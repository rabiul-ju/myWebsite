...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Updating Information<br><br></h2>
				<form name="updateInfo" method="post" action="">
					<h4>
						Update Name : <input type="text"></input><br><br>
					    Update About Me :<textarea type="text" row="6" col="4"></textarea><br><br>
						Update Picture : <input type="file"></input><br><br>
					</h4>
