...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Creating Blog<br><br></h2>
				<form name="updateInfo" method="post" action="../BlogServlet">
					<h4>
						Blog Title :</h4> <input type="text" name="blogTitle"></input><br><br>
						<h4>Blog Summary :</h4> <input type="text" name="blogSummary"></input><br><br>
					    <h4>Blog :</h4><textarea name="blog"></textarea><br><br>
						<h4>DateTime: </h4><input type="Date" name="date"></input><br><br>
